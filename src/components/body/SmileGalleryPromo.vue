    ...
    <section class="w-full py-16 px-6">
        <div class="max-w-6xl mx-auto text-center space-y-8">
            ...
            <p class="text-lg text-gray">
                We Provide The Treatment OPTIONS To Match Your BUDGET
            </p>

            <!-- Smile Gallery -->
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-6">
                <img v-for="n in 6" :key="n" :src="`/public/smile/smile${n}.webp`" :alt="`Smile ${n}`"
                    class="rounded-md shadow-md object-cover w-full h-auto" />
            </div>

            <!-- Bottom Message -->
            <h1 class="text-4xl font-bold text-center">
                A <span class="text-highlight-blue">brand-new</span>, smile. One day. No more dentures. Just a
                lifetime of confidence and comfort.
            </h1>
